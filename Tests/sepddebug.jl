using SpecialFunctions, Distributions, Test
include("sepd.jl")
using .SEPD
...
var(d) ≈ moments[2] - moments[1]^2
skewness(d) ≈ moments[3] / (√(moments[2] - moments[1]^2))^3
kurtosis(d) ≈ (moments[4] / ((moments[2] - moments[1]^2))^2 - 3)


d1 = SkewedExponentialPower(0, 1, .1, 0.7)
d2 = SkewedExponentialPower(0, 1, .1, 0.3)
